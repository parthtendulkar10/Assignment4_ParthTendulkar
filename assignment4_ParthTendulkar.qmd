...
joined_data <- age_gaps_raw %>%
  left_join(revenue_raw, by = c("Movie Name" = "movie", "Release Year" = "year"))

# cheking number of non matches
summary(joined_data$production_budget)
sum(!is.na(joined_data$production_budget))
